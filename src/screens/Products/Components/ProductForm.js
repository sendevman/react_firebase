...
class ProductForm extends Component {
  ...
  generateFake(element) {
    return [0, 1, 2].map(value => React.cloneElement(element, { key: value }));
  }

  render() {
    const { description, capacity, lifeTalk, lifeAudio, lifeVideo,
      lifeInternetLfourG, lifeInternetWiFi, chargingWired, chargingWireless,
      feature1, feature2, feature3, feature4, tabValue } = this.state;
                      ...
                      <Grid container spacing={16} className="upload-box">
                        <Grid item xs={12} md={6}>
                          <TextField
                            ...
                            value={capacity}
                            onChange={e => this._handleInputChange(e, 'capacity')}
                            InputProps={{ startAdornment: <InputAdornment position="start">GB</InputAdornment> }}
                            className="text-field-width"
                            margin="dense"
                          />
                        ...
                        <Tooltip title="Add Option" placement="top">
                          <label className="device-options-button">
                            <Button component="span" variant="contained" size="small" className="btn-icon-text att-blue">
                              <AddIcon />
                            </Button>
                          </label>
